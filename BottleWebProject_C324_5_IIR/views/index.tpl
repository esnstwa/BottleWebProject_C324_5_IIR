...
<section class="hero-section">
    <div class="hero-motion-bg" aria-hidden="true">
        <img class="motion-image motion-image-boat" src="/static/images/home-boat.png" alt="">
        <img class="motion-image motion-image-vertical" src="/static/images/home-vertical.png" alt="">
        <img class="motion-image motion-image-oncoming" src="/static/images/home-oncoming.png" alt="">
    </div>
