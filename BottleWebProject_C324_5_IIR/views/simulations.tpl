...
<div class="tabs-container">
    ...
    <div class="tab-content active">
        ...
        <!-- Инициализация модального окна обучения -->
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const riverTourSteps = [
                    {
                        title: 'Добро пожаловать в симуляцию переправы через реку!',
                        description: 'Эта симуляция показывает, как катер пересекает реку, борясь с течением. Давайте изучим интерфейс!'
                    },
                    {
                        title: 'Настройте параметры',
                        description: 'Используйте эти слайдеры, чтобы изменить скорость катера, скорость течения и ширину реки. Нажмите на иконки вопроса, чтобы узнать, что делает каждый параметр!'
                    },
                    {
                        title: 'Наблюдайте за анимацией',
                        description: 'Холст показывает путь катера в реальном времени. Жёлтая точка — это катер, и вы увидите, как его сносит вниз по течению во время переправы.'
                    },
                    {
                        title: 'Изучите результаты',
                        description: 'Эти рассчитанные значения показывают, когда катер достигнет противоположного берега и как далеко вниз по течению он окажется.'
                    }
                ];

                initOnboardingTour(riverTourSteps, 'river-crossing');
            });
        </script>
    </div>
    <!-- Вкладка: Вертикальный запуск -->
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const launchTourSteps = [
                    {
                        title: 'Добро пожаловать в симуляцию вертикального запуска!',
                        description: 'Эта симуляция показывает, что происходит, когда вы бросаете что-то прямо вверх. Давайте изучим, как гравитация влияет на это!'
                    },
                    {
                        title: 'Установите условия запуска',
                        description: 'Настройте, как быстро вы бросаете объект вверх и с какой высоты. Нажмите на иконки вопроса, чтобы понять каждый параметр!'
                    },
                    {
                        title: 'Наблюдайте за движением',
                        description: 'Анимация показывает, как объект поднимается вверх, замедляется, останавливается на пике, а затем падает обратно вниз. График отображает высоту во времени.'
                    },
                    {
                        title: 'Анализируйте результаты',
                        description: 'Посмотрите, как высоко он поднимется и как долго будет в воздухе.'
                    }
                ];

                initOnboardingTour(launchTourSteps, 'vertical-launch');
            });
        </script>
    </div>
    <!-- Вкладка: Встреча поездов -->
    ...
    <div class="tab-content active">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const trainsTourSteps = [
                    {
                        title: 'Добро пожаловать в симуляцию встречи поездов!',
                        description: 'Эта симуляция показывает два поезда, движущихся навстречу друг другу на параллельных путях. Давайте посмотрим, когда они полностью разойдутся!'
                    },
                    {
                        title: 'Настройте поезда',
                        description: 'Установите скорость и длину каждого поезда. Нажмите на иконки вопроса, чтобы узнать, как каждый параметр влияет на встречу!'
                    },
                    {
                        title: 'Наблюдайте за встречей',
                        description: 'Анимация показывает оба поезда, движущихся навстречу друг другу. Они встречаются, когда их головы выравниваются, и расходятся, когда их хвосты разделяются.'
                    },
                    {
                        title: 'Проверьте расчёты',
                        description: 'Посмотрите, когда именно они встретятся и какое расстояние пройдёт каждый поезд.'
                    }
                ];

                initOnboardingTour(trainsTourSteps, 'meeting-trains');
            });
        </script>
    </div>
    % end
